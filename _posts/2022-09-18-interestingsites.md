...
<p>All of these oversights will directly impact assistive technologies and, in turn, a desktop user with, e.g., low vision&rsquo;s ability to make use of the Elm Playground and its minimalist layout. While an accessibility score of 87 does not seem disastrous, on a relatively bare-bones site like the Elm Playground, these omissions could prove costly.</p>
